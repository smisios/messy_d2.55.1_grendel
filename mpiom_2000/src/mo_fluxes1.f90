...
!
!!#ifdef __coupled
      REAL(wp), ALLOCATABLE,TARGET :: AOFLTXWO(:,:)
      REAL(wp), ALLOCATABLE,TARGET :: AOFLTYWE(:,:)
      REAL(wp), ALLOCATABLE,TARGET :: AOFLTXIO(:,:)
      REAL(wp), ALLOCATABLE,TARGET :: AOFLTYIE(:,:)
      REAL(wp), ALLOCATABLE,TARGET :: AOFLFRIO(:,:)
      REAL(wp), ALLOCATABLE,TARGET :: AOFLFRWO(:,:)
      REAL(wp), ALLOCATABLE,TARGET :: AOFLRHIO(:,:)
      REAL(wp), ALLOCATABLE,TARGET :: AOFLCHIO(:,:)
      REAL(wp), ALLOCATABLE,TARGET :: AOFLNHWO(:,:)
      REAL(wp), ALLOCATABLE,TARGET :: AOFLSHWO(:,:)
      REAL(wp), ALLOCATABLE,TARGET :: AOFLWSVO(:,:)
!!#endif
...
!      call gather_arr(aoflnhwo,glfld,p_io)
      call gather(aoflnhwo,glfld,p_io)
      IF (p_parallel_io) THEN
...
!      call gather_arr(aoflshwo,glfld,p_io)
      call gather(aoflshwo,glfld,p_io)
      IF (p_parallel_io) THEN
      i4i2=271
...
!      call gather_arr(aoflrhio,glfld,p_io)
      call gather(aoflrhio,glfld,p_io)
      IF (p_parallel_io) THEN
      i4i2=272
...
!      call gather_arr(aoflchio,glfld,p_io)
      call gather(aoflchio,glfld,p_io)
      IF (p_parallel_io) THEN
      i4i2=273
...
!      call gather_arr(aoflfrwo,glfld,p_io)
      call gather(aoflfrwo,glfld,p_io)
      IF (p_parallel_io) THEN
      i4i2=274
...
!      call gather_arr(aoflfrio,glfld,p_io)
      call gather(aoflfrio,glfld,p_io)
      IF (p_parallel_io) THEN
      i4i2=275
...
!      call gather_arr(aofltxwo,glfld,p_io)
      call gather(aofltxwo,glfld,p_io)
      IF (p_parallel_io) THEN
      i4i2=276
...
!      call gather_arr(aofltywe,glfld,p_io)
      call gather(aofltywe,glfld,p_io)
      IF (p_parallel_io) THEN
      i4i2=277
...
!      call gather_arr(aofltxio,glfld,p_io)
      call gather(aofltxio,glfld,p_io)
      IF (p_parallel_io) THEN
      i4i2=278
...
!      call gather_arr(aofltyie,glfld,p_io)
      call gather(aofltyie,glfld,p_io)
      IF (p_parallel_io) THEN
      i4i2=279
...
!      call gather_arr(aoflwsvo,glfld,p_io)
      call gather(aoflwsvo,glfld,p_io)
      IF (p_parallel_io) THEN
      i4i2=280
