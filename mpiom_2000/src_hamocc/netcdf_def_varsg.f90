...
!
      ncstat =                                                          &
     &NF_DEF_VAR(kcid,yshort(1:kshort),NF_REAL,kdims,kcdims,kcvarid)
      IF ( ncstat .NE. NF_NOERR ) THEN
         ...
         WRITE(kunit,*) ystring
         CALL stop_all( 'STOP in NETCDF_DEF_VARSG' )
      ENDIF
!
!  Set unit
!
...
!
     ...
     &(kcid,kcvarid,'missing_value',NF_REAL,1,pmissing)
      IF ( ncstat .NE. NF_NOERR ) THEN
