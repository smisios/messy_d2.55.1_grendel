...
implicit none
      ...
      CHARACTER*(*) ystring
      INTEGER :: kunit,kpicycli,kpie,kpje,kpke,j,k,l
...
!
      ...
      DO k=1,ks,3
      DO j=1,kpje
      IF (ABS(powtra(1, j, k, l) - powtra(kpie-1, j, k, l)) .GT. 1.e-15_wp .OR.&
     &    ABS(powtra(2, j, k, l) - powtra(kpie, j, k, l)).GT. 1.e-15_wp) THEN
         WRITE(kunit,*)                                                &
...
!
      ...
      DO k=1,kpke
      DO j=1,kpje
      IF (ABS(ocetra(1, j, k, l) - ocetra(kpie-1, j, k, l)) .GT. 1.e-15_wp .OR.&
     &    ABS(ocetra(2, j, k, l) - ocetra(kpie, j, k, l)) .GT. 1.e-15_wp) THEN
         WRITE(kunit,*)                                                &
