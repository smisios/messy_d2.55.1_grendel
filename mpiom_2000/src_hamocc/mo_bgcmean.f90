...
#ifdef FB_BGC_OCE
     &          i_fb_m3d=1,                                   &
     &          jatten  = i_base_m3d+i_iso_m3d+i_agg_m3d+1
#else
     &          i_fb_m3d=0
#endif

      INTEGER, PARAMETER :: nbgcm3d = i_base_m3d + i_iso_m3d + i_agg_m3d + i_fb_m3d
...
!  3d 'total' fields
     ...
     &          jac14_t =i_bsc_t3d+3
      ...
      REAL(wp), DIMENSION (:),       ALLOCATABLE :: stepspm
      REAL(wp), DIMENSION (:,:,:),   ALLOCATABLE :: bgct2d               ! 2d summed-up field (js, ?[patrick's 'total')
      REAL(wp), DIMENSION (:,:,:),   ALLOCATABLE :: bgcm2d               ! 2d averaged  field
      REAL(wp), DIMENSION (:,:,:,:), ALLOCATABLE :: bgcm3d               ! 3d averaged  field
      REAL(wp), DIMENSION (:,:,:,:), ALLOCATABLE :: bgct3d               ! 3d summed-up field
      REAL(wp), DIMENSION (:,:,:,:), ALLOCATABLE :: bgct_sed             ! 3d sediment  field
