...
! mz_ht_20040414+ added target attribute so that the lookuptables 
!                 can be adressed via POINTERS  
  
  REAL(dp), TARGET :: tlucua(jptlucu1:jptlucu2)        ! table - e_s*Rd/Rv
  REAL(dp), TARGET :: tlucub(jptlucu1:jptlucu2)        ! table - for derivative calculation
  REAL(dp), TARGET :: tlucuc(jptlucu1:jptlucu2)        ! table - l/cp
  REAL(dp), TARGET :: tlucuaw(jptlucu1:jptlucu2)       ! table
! mz_ht_20040414-
