...
!!#D mlocean +
#ifdef MESSY
  USE messy_main_switch, ONLY: USE_MLOCEAN   ! fb_mk_20110201
#endif
!!#D mlocean -
  !
  IMPLICIT NONE
...
#else
    !fb_mk_20110201+
    IF (.NOT.lmlo .AND. .NOT.lcouple .AND. .NOT.USE_MLOCEAN) THEN ! ECHAM5
    !fb_mk_20110202-
#endif
!!#D mlocean -
      DO jl=1,kproma
...
!!#D mlocean +
      ...
      !fb_mk_20110201+
      ! For USE_MLOCEAN: 
      ! The ice temperature is calculated in the submodel core layer.
   ELSE IF (lmlo .AND. .NOT.USE_MLOCEAN) THEN
      !fb_mk_20110202-
#endif
!!#D mlocean -
      DO jl=1,kproma
