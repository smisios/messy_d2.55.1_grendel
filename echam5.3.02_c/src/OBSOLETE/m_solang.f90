...
#ifdef MESSY
 ! mz_cb_20030527+  additional routine for twilight
SUBROUTINE solang_extended_consc(p1,p2,p3,pamu0)
  ...
  DO jlat = 1, lnlat
    ...
    CALL solangc(lnlon, coslon(1+nlof:lnlon+nlof), sinlon(1+nlof:lnlon+nlof), &
                ztim1, ztim2, ztim3,     &
                zpamu0(:,jlat))
...
END SUBROUTINE solang_extended_consc
 ! mz_cb_20030527-
#endif
...
#ifdef MESSY
! mz_cb_20030527+   short without cut off
SUBROUTINE solangc(klon,coslon,sinlon, &
     &            ptim1,ptim2,ptim3,  &
     &            pamu0)
