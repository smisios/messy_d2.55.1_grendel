SUBROUTINE setgws
  ...
  USE mo_gwspectrum     ,ONLY: lextro,lfront,lozpr,iheatcal,       &
                               ...
                               emiss_press   ! mz_jb_20040107
  USE mo_control        ,ONLY: nn, nvclev, vct   ! mz_jb_20040107
  USE mo_namelist       ,ONLY: position_nml, nnml, POSITIONED
  USE mo_hyb            ,ONLY: apzero   ! mz_jb_20040107
  ...
  INTRINSIC abs, epsilon, minloc, sum   ! mz_jb_20040107
  ...
  IF (p_parallel) THEN
     ...
     !CALL p_bcast (emiss_lev, p_io)    ! mz_jb_20040107
     CALL p_bcast (emiss_press, p_io)   ! mz_jb_20040107
