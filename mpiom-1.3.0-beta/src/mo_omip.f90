...
!mz_ap_2007062+
  ...
  SUBROUTINE rewind_omip
    ...
    !rewind the forcing files
       ...
       WRITE(io_stdout,*) 'forcing data are rwind '

  ENDSUBROUTINE rewind_omip

  SUBROUTINE spool_omip_day
    ...
    !spool the fields to the actual month
          ...
          DO lday=1,ldays-1
             ...
             WRITE(io_stdout,*)'spool: ',lmont1,lday
          ENDDO
       WRITE(io_stdout,*) 'forcing data is spooled to day ',lday

  END SUBROUTINE spool_omip_day
...
!       WRITE(io_stdout,*)'read forcing: ',lmonts,ldays,ii1
       ...
       CALL bounds_exch('v',TYE,'mo_omip 2')
