...
#ifdef __coupled
        if (IOASISFLUX.ne.0 .and. IOASISFLUX.ne.4) then
           CALL MMEAN2D(KDAYS,KMONTS,KYEARS,NANF,NEND,IO_OU_AONHW           &
                ,AOFLNHWO,SUM_AOFLNHW,270,0)
           CALL MMEAN2D(KDAYS,KMONTS,KYEARS,NANF,NEND,IO_OU_AOSHW           &
                ,AOFLSHWO,SUM_AOFLSHW,271,0)
           CALL MMEAN2D(KDAYS,KMONTS,KYEARS,NANF,NEND,IO_OU_AORHI           &
                ,AOFLRHIO,SUM_AOFLRHI,272,0)
           CALL MMEAN2D(KDAYS,KMONTS,KYEARS,NANF,NEND,IO_OU_AOCHI           &
                ,AOFLCHIO,SUM_AOFLCHI,273,0)
           CALL MMEAN2D(KDAYS,KMONTS,KYEARS,NANF,NEND,IO_OU_AOFRW           &
                ,AOFLFRWO,SUM_AOFLFRW,274,0)
           CALL MMEAN2D(KDAYS,KMONTS,KYEARS,NANF,NEND,IO_OU_AOFRI           &
                ,AOFLFRIO,SUM_AOFLFRI,275,0)
           CALL MMEAN2D(KDAYS,KMONTS,KYEARS,NANF,NEND,IO_OU_AOTXW           &
                ,AOFLTXWO,SUM_AOFLTXW,276,0)
           CALL MMEAN2D(KDAYS,KMONTS,KYEARS,NANF,NEND,IO_OU_AOTYW           &
                ,AOFLTYWE,SUM_AOFLTYW,277,0)
           CALL MMEAN2D(KDAYS,KMONTS,KYEARS,NANF,NEND,IO_OU_AOTXI           &
                ,AOFLTXIO,SUM_AOFLTXI,278,0)
           CALL MMEAN2D(KDAYS,KMONTS,KYEARS,NANF,NEND,IO_OU_AOTYI           &
                ,AOFLTYIE,SUM_AOFLTYI,279,0)
           CALL MMEAN2D(KDAYS,KMONTS,KYEARS,NANF,NEND,IO_OU_AOWSV           &
                ,AOFLWSVO,SUM_AOFLWSV,280,0)
        endif
#endif /*__coupled*/
!
