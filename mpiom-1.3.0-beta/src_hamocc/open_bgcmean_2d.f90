...
!-----------------------------------------------------------------------
      ...
      CALL NETCDF_DEF_VARSG(nc_2d_id,9,'co214flux',2,ncdims,ncvarid,       &
     &   9,'kmol/m**2',10, 'CO214 Flux',rmasko,40,io_stdo_bgc)

      CALL NETCDF_DEF_VARSG(nc_2d_id,7,'co2flux',2,ncdims,ncvarid,         &
     &   9,'kmol/m**2',8, 'CO2 Flux',rmasko,41,io_stdo_bgc)
     
      CALL NETCDF_DEF_VARSG(nc_2d_id,7,'n2oflux',2,ncdims,ncvarid,    &
     &   9,'kmol/m**2',8, 'N2O Flux',rmasko,42,io_stdo_bgc)
     
      CALL NETCDF_DEF_VARSG(nc_2d_id,6,'prorca',2,ncdims,ncvarid,          &
     &   9,'kmol/m**2',22, 'detritus sediment flux',rmasko,43,io_stdo_bgc)
     
      CALL NETCDF_DEF_VARSG(nc_2d_id,6,'prcaca',2,ncdims,ncvarid,          &
     &   9,'kmol/m**2',19, 'CaCO3 sediment flux',rmasko,44,io_stdo_bgc)     

      CALL NETCDF_DEF_VARSG(nc_2d_id,6,'silpro',2,ncdims,ncvarid,          &
     &   9,'kmol/m**2',18, 'opal sediment flux',rmasko,45,io_stdo_bgc) 

      CALL NETCDF_DEF_VARSG(nc_2d_id,6,'produs',2,ncdims,ncvarid,          &
     &   7,'kg/m**2',41, 'dust flux to sediment (free + aggregated)',rmasko,46,io_stdo_bgc) 

#ifdef ANTC14
      CALL NETCDF_DEF_VARSG(nc_2d_id,7,'rantc14',2,ncdims,ncvarid,          &
...
!     &   5,'steps',25,'model timesteps per month',rmasko,30,io_stdo_bgc)  
      ...
      CALL NETCDF_DEF_VARSG(nc_2d_id,4,'time',1,ncdims,ncvarid,          &
...
#ifdef DIFFAT
#ifndef __cpl_co2
      CALL NETCDF_DEF_VARSG(nc_2d_id,12,'emission_p_s',4,ncdims,ncvarid,   &
     &   4,'kmol',28, 'kmol CO2 added to atmosphere',rmasko,34,io_stdo_bgc) 
#endif
#endif      
#endif
!
...
!!$      CALL NETCDF_DEF_VARSG(nc_2d_id,10,'dpco2_dalk',3,ncdims,ncvarid,         &
!!$     &   3,'ppm',20, 'CO2 partial-pressure',rmasko,52,io_stdo_bgc)
!!$         
!!$      CALL NETCDF_DEF_VARSG(nc_2d_id,10,'dpco2_ddic',3,ncdims,ncvarid,         &
!!$     &   3,'ppm',20, 'CO2 partial-pressure',rmasko,52,io_stdo_bgc)
!!$         
!!$      CALL NETCDF_DEF_VARSG(nc_2d_id,10,'dpco2_dsst',3,ncdims,ncvarid,         &
!!$     &   3,'ppm',20, 'CO2 partial-pressure',rmasko,52,io_stdo_bgc)         
!!$        
!!$      CALL NETCDF_DEF_VARSG(nc_2d_id,10,'dpco2_dsss',3,ncdims,ncvarid,         &
!!$     &   3,'ppm',20, 'CO2 partial-pressure',rmasko,52,io_stdo_bgc)     
