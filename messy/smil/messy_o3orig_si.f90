...
!          Volker Grewe
!          Patrick Joeckel,   DLR,   October 2010    inclusion in Messy1.11/2.41
...
!    USE messy_main_tracer_mem_e5, ONLY: GPTRSTR, AIR, OFF, ON !, LGTRSTR
    ...
    USE messy_main_tracer         , ONLY: new_tracer,set_tracer, R_MOLARMASS, R_PSS  , R_dryreac_sf,  &
                                                  I_DRYDEP, I_SCAV, AIR, OFF, ON !, LGTRSTR
! ak_03082010-
...
#ifdef MESSYTENDENCY
         CALL mtend_register(my_handle,itrac_o3orig(i_trac))
#endif
...
!                                     press_3d                         ! Better in init_coupling?
    USE messy_main_grid_def_mem_bi, ONLY: jrow, kproma, nproma,         &
                                          nlev, nlon
    USE messy_main_data_bi,    ONLY: press_3d                         ! Better in init_coupling?
...
!   REAL(DP), DIMENSION(kproma,nlev,n_trac_orig)     :: o3origM1  !sm_18082010 sm_02092010
    ...
    CASE(1)                    ! Pre-MECCA
       ...
       idt = idx_O3
       o3m1(_RI_XYZ__(1:kproma,jrow,:)) = pxtm1(_RI_X_ZN_(1:kproma,:,idt)) &
                 + pxtte(_RI_X_ZN_(1:kproma,:,idt)) * time_step_len
#else
       CALL mtend_get_start_l(idx_O3, v0=o3m1(_RI_XYZ__(1:kproma,jrow,:)))
#endif
       ! um_ak_20110719-
...
#ifndef MESSYTENDENCY
       idt = idx_O3
       o3(_RI_XYZ__(1:kproma,jrow,:))   = pxtm1(_RI_X_ZN_(1:kproma,:,idt)) &
                   + pxtte(_RI_X_ZN_(1:kproma,:,idt)) * time_step_len
#else
       CALL mtend_get_start_l(idx_O3, v0=o3(_RI_XYZ__(1:kproma,jrow,:)))
#endif
        co3(_RI_XYZ__(:,jrow,:))=(o3(_RI_XYZ__(:,jrow,:))-o3m1(_RI_XYZ__(:,jrow,:)))/time_step_len  ! per second!
        do jt=1,i_trac_orig
#ifndef MESSYTENDENCY
           idt = itrac_o3orig(jt)
           o3_orig(1:kproma,:,jt)  = pxtm1(_RI_X_ZN_(1:kproma,:,idt))  &
              + pxtte(_RI_X_ZN_(1:kproma,:,idt)) * time_step_len
#else
           CALL mtend_get_start_l( itrac_o3orig(jt) &
                , v0=o3_orig(1:kproma,:,jt))
#endif
        enddo
       ! um_ak_20110719-
...
#ifndef MESSYTENDENCY
        idt = idx_O3losst
        o3losst(_RI_XYZ__(1:kproma,jrow,:)) = pxtte(_RI_X_ZN_(1:kproma,:,idt))
        o3l(1:kproma,:)           = pxtte(_RI_X_ZN_(1:kproma,:,idt))

        idt = idx_O3prod
        o3prod(_RI_XYZ__(1:kproma,jrow,:)) = pxtte(_RI_X_ZN_(1:kproma,:,idt))
        o3p(1:kproma,:)          = pxtte(_RI_X_ZN_(1:kproma,:,idt))
       ! um_ak_20110719-
#else
        CALL mtend_get_start_l(idx_O3losst, v0=o3losst(_RI_XYZ__(1:kproma,jrow,:)))
        CALL mtend_get_start_l(idx_O3losst, v0=o3l(1:kproma,:))
        CALL mtend_get_start_l(idx_O3prod,  v0=o3prod(_RI_XYZ__(1:kproma,jrow,:)))
        CALL mtend_get_start_l(idx_O3prod , v0=o3p(1:kproma,:))
#endif
...
! um_ak_20110719 press_3d(:,:,jrow),                         & ! Input  (Pressure)
             press_3d(_RI_XYZ__(1:kproma,jrow,:)),                 & ! Input  (Pressure)
             o3l(1:kproma,:),o3p(1:kproma,:),            & ! Input  (Chem)
! um_ak_20110719 o3(:,:,jrow),o3m1(:,:,jrow),            & ! Input  (Chem)
             o3(_RI_XYZ__(1:kproma,jrow,:)),o3m1(_RI_XYZ__(1:kproma,jrow,:)),& ! Input  (Chem)
...
!         o3prod(1:kproma,:,jrow)     = o3p(1:kproma,:)
         o3lossd(_RI_XYZ__(1:kproma,jrow,:))    = o3l(1:kproma,:)
         o3prod(_RI_XYZ__(1:kproma,jrow,:))     = o3p(1:kproma,:)
! um_ak_20110719-
...
!             + (o3_orig(1:kproma,:,jt)-o3_origM1(1:kproma,:,jt)) / time_step_len
         do jt=1,i_trac_orig
            ...
            zxtte(1:kproma,:) = &
                (o3_orig(1:kproma,:,jt)-o3_origM1(1:kproma,:,jt)) / time_step_len
            CALL mtend_add_l(my_handle,itrac_o3orig(jt), px= zxtte(1:kproma,:))
#endif
! um_ak_20110719-
         enddo
    CASE DEFAULT
    ...
    IF (status/=0) THEN
       write(iouerr,*) 'incorrect value for i_o3orig_ctrl ', i_o3orig_ctrl
       CALL error_bi(&
...
! ----------------------------------------------------------------------
  ...
  DEALLOCATE(o3_orig)   ; NULLIFY(o3_orig)
  DEALLOCATE(o3_origm1) ; NULLIFY(o3_origm1)
