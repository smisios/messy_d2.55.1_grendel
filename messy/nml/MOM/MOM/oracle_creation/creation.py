...
#print(spc,spc_comp)
spc_eqn_file = read_eqn("../../../../mbm/caaba/messy_mecca_kpp.f90")
#print(spc_eqn_file)
...
oracle.write("! please check import data for correct unit.                                                                                                                                       \n")  
oracle.write("! ! these are in mlc/m^2s, based on molar mass of 12. We want to go back to Kg/m^2s i.e. 12/6.023E23/1000 =1.99E-26                                                                \n")  
oracle.write("! for EDGAR_ANTH_OC_FLUX this is done in the import path                                                                                                                           \n")  
