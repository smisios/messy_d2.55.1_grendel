...
def read_eqn(fname):
    ...
    for line_index,line in enumerate(data):
        ...
        spc_eqn, sep, trash = info.partition('=')
        out_spc_eqn.append(spc_eqn.translate(None,'idt_'))
    file.close() 
    return out_spc_eqn
...
oracle.write("deltah   (1:5) = 112.d3,100.d3, 88.d3, 76.d3, 64.d3,  !deltah(1:NfPOA)   : enthalpy of vaporization of fPOG/fPOA species (kJ/mol)     \n")                       
...
oracle.write("deltah   (6:9) = 93.d3, 85.d3, 77.d3, 69.d3,   !deltah(n1:n2)   : enthalpy of vaporization of bbPOG/bbPOA species (kJ/mol)            \n")               
...
oracle.write("deltah   (10:11) = 112.d3,100.d3,  !deltah(n3:n4)   : enthalpy of vaporization of fSOGsv/fSOAsv species (kJ/mol)                      \n")
...
oracle.write("deltah   (12:13) = 93.d3, 85.d3,   !deltah(n5:n6)   : enthalpy of vaporization of bbSOGsv/bbSOAsv species (kJ/mol)                    \n")
...
oracle.write("deltah   (14:17) = 112.d3,100.d3, 88.d3, 76.d3,  !deltah(n7:n8)   : enthalpy of vaporization of fSOGiv/fSOAiv species (kJ/mol)        \n")
...
oracle.write("deltah   (18:20) = 93.d3, 85.d3, 77.d3,   !deltah(n9:n10)   : enthalpy of vaporization of bbSOGiv/bbSOAiv species (kJ/mol)            \n")               
...
for data in bins: 
         oracle.write("30.d3,")
oracle.write("!deltah(n11:n12)   : enthalpy of vaporization of bSOGv/bSOAv species (kJ/mol)      \n")               
...
spc_file, spc_comp_file = read_spc("/gaia/u/andrep/MESSy/messy_2.53.0_MOM/messy/mbm/caaba/mecca/mecca.spc")
#print(spc,spc_comp)
spc_eqn_file = read_eqn("/gaia/u/andrep/MESSy/messy_2.53.0_MOM/messy/mbm/caaba/mecca/messy_mecca_idt_si.inc")
#print(spc_eqn)
...
#           bin_vol, bin_mw = calc_vol(spc_eqn_file, spc_file, spc_comp_file, edges[0], edges[1])
#           oracle.write("SOGv01 = '")
#           for trac in bin_vol:
#               print(trac)
#               oracle.write(trac+";")
...
#           oracle.write("\n")
#           continue
#        if bins_index == nbins-1:
#           print(edges[bins_index], edges[bins_index+1])
#           bin_vol, bin_mw = calc_vol(spc_eqn_file, spc_file, spc_comp_file,(bins[bins_index]+bins[bins_index-1])/2, (bins[nbins-1]+bins[nbins-1])/2)
...
for bins_index,bin in enumerate(bins[0:nbins]):
        #        print(bins_index)
        #        if bins_index == 0:
        #           print("1.0E-20", (bins[0]+bins[1])/2)
        #           bin_vol, bin_mw = calc_vol(spc_eqn_file, spc_file, spc_comp_file, 1.0E-20, (bins[0]+bins[1])/2)
        #           n_mw = str(len(bin_mw))
        #           oracle.write("SOGv_mw(1,1:"+n_mw+") = '")
        #           for trac in bin_mw:
        #               print(trac)
        ...
        #           continue
        #        if bins_index == nbins-1:
        #           print((bins[bins_index]+bins[bins_index-1])/2, (bins[nbins-1]+bins[nbins-1]*10)/2)
        #           bin_vol, bin_mw = calc_vol(spc_eqn_file, spc_file, spc_comp_file,(bins[bins_index]+bins[bins_index-1])/2, (bins[nbins-1]+bins[nbins-1])/2)
        #           nml_value=str(bins_index+1)
        #           n_mw = str(len(bin_mw))
...
oracle.write("!                                                                                                                                                                                  \n")  
oracle.write("! CCMI                                                                                                                                                                             \n")  
oracle.write("!EMIS_CASK(1,:)= \"oc_mass_ff_ks\"  ,\"1.3\",\"import_grid\" ,\"OC_ant_OC\"   ,\"\"            ,\"fPOA01_ks;fPOA02_ks;LfPOG03;LfPOG04;LfPOG05\",\"0.09;0.23;0.48;0.7;1.0\"         \n")  
oracle.write("! use only one gmxe mode (as)                                                                                                                                                      \n")  
oracle.write("EMIS_CASK(1,:)= \"oc_mass_ff_as\"  ,\"1.3\",\"import_grid\" ,\"EDGAR_ANTH_OC\"   ,\"\"            ,\"fPOA01_as;fPOA02_as;LfPOG03;LfPOG04;LfPOG05\",\"0.09;0.23;0.48;0.7;1.0\"      \n")  
oracle.write("! GFEDv3.1                                                                                                                                                                         \n")  
oracle.write("!EMIS_CASK(2,:)= \"oc_mass_bb_ks\"  ,\"1.6\",\"offemis\"    ,\"OC_wf_OC\"    ,\"\"            ,\"bbPOA01_ks;bbPOA02_ks;LbbPOG03;LbbPOG04\",\"0.2;0.2;0.3;0.3\"                     \n")  
oracle.write("EMIS_CASK(2,:)= \"oc_mass_bb_as\"  ,\"1.6\",\"bioburn\"    ,\"OC_flux\"    ,\"\"            ,\"bbPOA01_as;bbPOA02_as;LbbPOG03;LbbPOG04\",\"0.2;0.2;0.3;0.3\"                       \n")  
oracle.write("!-----------------                                                                                                                                                                 \n")  
oracle.write("/                                                                                                                                                                                  \n")  
