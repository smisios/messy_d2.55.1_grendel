...
!!$! mz_pj_20090519+
!!$  USE messy_main_timer,         ONLY: time_span_s ! mz_pj_20080327
!!$  USE messy_main_timer,         ONLY: time_span_d ! mz_pj_20080327
!!$! mz_pj_20090519-
...
RETURN
  ...
  g%file = 'METEODIAG_GEO-HYBRID-GRID'       ! Filename
  g%t    = 0                               ! time step
...
!!$  ranges(2,2) =  90.0_dp
  ...
  CALL INIT_NARRAY(g%hybi%dat, g%hybi%ndims, (/g%hybi%dim(1)%len/) &
                   ,VTYPE_REAL)
  g%hybi%dat%vr(:) =  (/100._dp, 200._dp, 500._dp/) !vct(nvclev+1:2*nvclev)
  ! ... attributes
