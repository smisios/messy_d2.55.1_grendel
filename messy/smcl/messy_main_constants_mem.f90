...
MODULE messy_main_constants_mem
...
#ifdef _VCSREV_
  CHARACTER(LEN=*), PARAMETER :: modver = _VCSREV_
#else
  CHARACTER(LEN=*), PARAMETER :: modver = 'd2.55.1'
#endif

  ! DISTRIBUTION MODIFICATION (please do NOT modify the next line!)
  ! OPTIONS: d2.55.1 -r -2 -k2 -COSMO -ICON -FESOM2 -CLM -CESM1
  ...
  ! LOGICAL I/O units
  INTEGER, PARAMETER :: iouerr = 0

  ! FLAGS
  REAL(DP), PARAMETER :: FLAGGED_BAD = -1.0E+34_dp  ! FERRET
  INTEGER,  PARAMETER :: INT_UNDEF   = -9999
...
! mz_ht_20160302+
  ...
  REAL(dp), PARAMETER :: MFe =  55.847_dp
! mz_ht_20160302-
  ...
  ! fb_mk_20101021-
  ! ub_ak_20190214+
  REAL(dp), PARAMETER :: rho_snow = 300._dp   ! density of snow [kg/m3]
  ! ub_ak_20190214-
