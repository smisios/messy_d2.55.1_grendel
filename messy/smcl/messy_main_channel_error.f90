...
CONTAINS
  ...
  FUNCTION channel_error_str(status)
    ...
    CASE('0000')
       ...
       ! GERENIC ERRORS
    CASE('0100')
       channel_error_str = 'E'//echar//': ERROR IN STRING CONVERSION'
    ...
    CASE('0956')
       channel_error_str = 'E'//echar//': DIMENSION VARIABLE UPDATE NOT ASSOCIATED'
    CASE('0957')
       channel_error_str = 'E'//echar//': DIMVAR_INFO: EITHER NAME OR SUBNAME MUST BE PROVIDED'
    CASE('0958')
       channel_error_str = 'E'//echar//': DIMVALUE: REQUESTED AXIS NOT AVAILABLE'
    CASE('0959')
       channel_error_str = 'E'//echar//': DIMVALUE: REQUESTED AXIS TWO TIMES AVAILABLE FOR CHANNEL OBJECT'
    ...
    CASE('2045')
       channel_error_str = 'E'//echar//': REDUCTION BY TWO RANKS IMPLIES 2D PTR'
    CASE('2050')
       channel_error_str = 'E'//echar//': RANK OF CHANNEL OBJECT TOO SMALL!'
    CASE('2051')
       channel_error_str = 'E'//echar//': OBJECT DOES NOT HAVE A Z-AXIS!'
    CASE('2052')
       channel_error_str = 'E'//echar//': OBJECT DOES NOT HAVE A N-AXIS!'
    CASE('2053')
       channel_error_str = 'E'//echar//': OBJECT DOES NOT HAVE A T-AXIS!'
    CASE('2054')
       channel_error_str = 'E'//echar//': THREE DIMINISHERS ARE TOO MUCH!'
    CASE('2060')
       channel_error_str = 'E'//echar//': INDEX FOR RANK REDUCTION NEEDS TO BE > 0!'
    CASE('2100')
    ...
    CASE('3213')
       channel_error_str = 'E'//echar//': PARALLEL DISTRIBUTION METHOD NOT AVAILABLE'
    CASE('3214')
       channel_error_str = 'E'//echar//': PARALLEL DISTRIBUTION EXCEEDS TASK RANGE'
    ...
    CASE('4003')
       ...
       ! CDI additions
    CASE('4010')
       channel_error_str = 'E'//echar//': CDI ERROR'
    CASE('4011')
       channel_error_str = 'E'//echar//': UNDEFINED CDI FILE/STREAM-ID'
    CASE('4012')
       channel_error_str = 'E'//echar//': UNDEFINED CDI VLIST-ID'
    CASE('4013')
       channel_error_str = 'E'//echar//': UNDEFINED CDI VAR-ID'
    CASE('4014')
       channel_error_str = 'E'//echar//': UNKNOWN PRECISION FLAG FOR CDI'
    CASE('4015')
       channel_error_str = 'E'//echar//': UNKNOWN HGRID FOR CDI'

       ! FORPY additions
    CASE('5001')
       channel_error_str = 'E'//echar//': FORPY CANNOT BE USED FOR RESTART FILES'
    CASE('5002')
       channel_error_str = 'E'//echar//': FORPY CANNOT BE USED TO READ'
    CASE('5003')
       channel_error_str = 'E'//echar//': FORPY CANNOT LOAD NUMPY'
    CASE('5004')
       channel_error_str = 'E'//echar//': FORPY CANNOT LAUNCH PYTHON KERNEL'
    CASE('5005')
       channel_error_str = 'E'//echar//': FORPY CANNOT LOAD PATH INFORMATION'
    CASE('5006')
       channel_error_str = 'E'//echar//': FORPY CANNOT ADD LOCAL PATH'
    CASE('5007')
       channel_error_str = 'E'//echar//': FORPY CANNOT LOAD channel.py'
    CASE('5008')
       channel_error_str = 'E'//echar//': FORPY CANNOT CREATE ARGUMENTS'
    CASE('5009')
       channel_error_str = 'E'//echar//': FORPY CANNOT CALL PYTHON FUNCTION'
    CASE('5010')
       channel_error_str = 'E'//echar//': FORPY CANNOT CAST STATUS'
    CASE('5011')
       channel_error_str = 'E'//echar//': FORPY CANNOT CONVERT CHANNEL TO DICTIONARY'
    CASE('5012')
       channel_error_str = 'E'//echar//': FORPY CANNOT CONVERT ATTRIBUTES TO DICTIONARY'
