...
! **********************************************************************
  ...
  PUBLIC :: submodel_init_memory
  PUBLIC :: submodel_global_end
  PUBLIC :: submodel_free_memory

CONTAINS

  ! --------------------------------------------------------------------
  SUBROUTINE submodel_init_memory
    ...
    ! LOCAL
    CHARACTER(LEN=*), PARAMETER :: substr = 'submodel_init_memory'
    INTEGER :: status
  ...
  END SUBROUTINE submodel_init_memory
  ! --------------------------------------------------------------------

  ! --------------------------------------------------------------------
  SUBROUTINE submodel_global_end

    ! BML/BMIL
    USE channel_mem_bml,           ONLY: lresume, NH

    IMPLICIT NONE
    INTRINSIC :: SUM, UBOUND
  ...
  END SUBROUTINE submodel_global_end
  ! --------------------------------------------------------------------

  ! --------------------------------------------------------------------
  SUBROUTINE submodel_free_memory

    IMPLICIT NONE

    CALL RANCLEAN

  END SUBROUTINE submodel_free_memory
  ! --------------------------------------------------------------------

! **********************************************************************
END MODULE messy_submodel_si
! **********************************************************************
