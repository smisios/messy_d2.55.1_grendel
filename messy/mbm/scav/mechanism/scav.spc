...
{xscav was run on 2020-11-16 at 17:05:46 by joec_pa on machine lx134.pa.op.dlr.de}
{***** START: gas-phase species from gas.spc *****}
{Time-stamp: <2020-06-23 11:58:50 b302010>}
...
BUT2OLO2        =  4C +  9H +  3O      ; {@BUT2OLO2}          {MCM}
...
CATECHOL        =  6C +  4H +  2O      ; {@CATECHOL}          {MCM: 1,2-dihydroxybenzene}
...
{**** START: aerosol species (phase 1) from ice.spc ****}
{-----------------------------------------------------------------------------}
{-------------------------------- ice phase (i) ------------------------------}
{-----------------------------------------------------------------------------}
...
{------------------------------------- O -------------------------------------}
 ...
 O2_i         = IGNORE; {@\FormatAq<O_2\ice><##>}          {oxygen}
 O3_i         = IGNORE; {@\FormatAq<O_3\ice><##>}          {ozone}

{------------------------------------- H -------------------------------------}

 OH_i         = IGNORE; {@\FormatAq<OH\ice><##>}           {hydroxyl radical}
 HO2_i        = IGNORE; {@\FormatAq<HO_2\ice><##>}         {perhydroxyl radical}
 H2O_i        = IGNORE; {@\FormatAq<H_2O\ice><##>}         {water}
 H2O2_i       = IGNORE; {@\FormatAq<H_2O_2\ice><##>}       {hydrogen peroxide}

{------------------------------------- N -------------------------------------}

 NH3_i        = IGNORE; {@\FormatAq<NH_3\ice><##>}         {ammonia}
 NO_i         = IGNORE; {@\FormatAq<NO\ice><##>}           {nitric oxide}
 NO2_i        = IGNORE; {@\FormatAq<NO_2\ice><##>}         {nitrogen dioxide}
 NO3_i        = IGNORE; {@\FormatAq<NO_3\ice><##>}         {nitrogen trioxide}
 HONO_i       = IGNORE; {@\FormatAq<HONO\ice><##>}         {nitrous acid}
 HNO3_i       = IGNORE; {@\FormatAq<HNO_3\ice><##>}        {nitric acid}
 HNO4_i       = IGNORE; {@\FormatAq<HNO_4\ice><##>}        {pernitric acid}
 N2O5_i       = IGNORE; {@\FormatAq<N_2O_5\ice><##>}       {dinitrogen pentoxide}

{------------------------------------- C -------------------------------------}

{1C}
 CH3OH_i      = IGNORE; {@\FormatAq<CH_3OH\ice><##>}       {methanol}
 HCOOH_i      = IGNORE; {@\FormatAq<HCOOH\ice><##>}        {formic acid}
 HCHO_i       = IGNORE; {@\FormatAq<HCHO\ice><##>}         {methanal (formaldehyde)}
 CH3O2_i      = IGNORE; {@\FormatAq<CH_3OO\ice><##>}       {methylperoxy radical}
 CH3OOH_i     = IGNORE; {@\FormatAq<CH_3OOH\ice><##>}      {}
 CO2_i        = IGNORE; {@\FormatAq<CO_2\ice><##>}         {carbon dioxide}

{2C}
 CH3CO2H_i    = IGNORE; {@\FormatAq<CH_3COOH\ice><##>}     {acetic acid}
 PAN_i        = IGNORE; {@\FormatAq<PAN\ice><##>}          {peroxyacetylnitrate}
 C2H5O2_i     = IGNORE; {@\FormatAq<C_2H_5O_2\ice><##>}    {ethylperoxy radical}
 CH3CHO_i     = IGNORE; {@\FormatAq<CH_3CHO\ice><##>}      {acetaldehyde}

{3C}
 CH3COCH3_i   = IGNORE; {@\FormatAq<CH_3COCH_3\ice><##>}   {acetone}

{------------------------------------- Cl ------------------------------------}

 Cl_i         = IGNORE; {@\FormatAq<Cl\ice><##>}           {chlorine atom}
 Cl2_i        = IGNORE; {@\FormatAq<Cl_2\ice><##>}         {molecular chlorine}
 HCl_i        = IGNORE; {@\FormatAq<HCl\ice><##>}          {hydrogen chloride}
 HOCl_i       = IGNORE; {@\FormatAq<HOCl\ice><##>}         {hypochlorous acid}

{------------------------------------- Br ------------------------------------}

 Br_i         = IGNORE; {@\FormatAq<Br\ice><##>}           {bromine atom}
 Br2_i        = IGNORE; {@\FormatAq<Br_2\ice><##>}         {molecular bromine}
 HBr_i        = IGNORE; {@\FormatAq<HBr\ice><##>}          {hydrogen bromide}
 HOBr_i       = IGNORE; {@\FormatAq<HOBr\ice><##>}         {hypobromous acid}
 BrCl_i       = IGNORE; {@\FormatAq<BrCl\ice><##>}         {bromine chloride}

{------------------------------------- I -------------------------------------}

 I2_i         = IGNORE; {@\FormatAq<I_2\ice><##>}          {molecular iodine}
 IO_i         = IGNORE; {@\FormatAq<IO\ice><##>}           {iodine monoxide radical}
 HI_i         = IGNORE; {@\FormatAq<HI\ice><##>}           {hydrogen iodide}
 HOI_i        = IGNORE; {@\FormatAq<HOI\ice><##>}          {hypoiodous acid}
 ICl_i        = IGNORE; {@\FormatAq<ICl\ice><##>}          {iodine chloride}
 IBr_i        = IGNORE; {@\FormatAq<IBr\ice><##>}          {iodine bromide}
 HIO3_i       = IGNORE; {@\FormatAq<HIO_3\ice><##>}        {iodic acid}

{------------------------------------- S -------------------------------------}

 SO2_i        = IGNORE; {@\FormatAq<SO_2\ice><##>}         {sulfur dioxide}
 H2SO4_i      = IGNORE; {@\FormatAq<H_2SO_4\ice><##>}      {sulfuric acid}
 DMSO_i       = IGNORE; {@\FormatAq<DMSO\ice><##>}         {dimethyl sulfoxide: CH3SOCH3}

{----------------------------------- ions ------------------------------------}

{------------------------------------- O -------------------------------------}

 O2m_i        = IGNORE; {@\FormatAq<O_2^-\ice><##>}        {}
 OHm_i        = IGNORE; {@\FormatAq<OH^-\ice><##>}         {}

{------------------------------------- H -------------------------------------}

 Hp_i         = IGNORE; {@\FormatAq<H^+\ice><##>}          {}

{------------------------------------- N -------------------------------------}

 NH4p_i       = IGNORE; {@\FormatAq<NH_4^+\ice><##>}       {ammonium}
 NO2m_i       = IGNORE; {@\FormatAq<NO_2^-\ice><##>}       {nitrite}
 NO3m_i       = IGNORE; {@\FormatAq<NO_3^-\ice><##>}       {nitrate}
 NO4m_i       = IGNORE; {@\FormatAq<NO_4^-\ice><##>}       {peroxy nitrate}

{------------------------------------- C -------------------------------------}

{1C}
 CO3m_i       = IGNORE; {@\FormatAq<CO_3^-\ice><##>}       {}
 HCOOm_i      = IGNORE; {@\FormatAq<HCOO^-\ice><##>}       {formate}
 HCO3m_i      = IGNORE; {@\FormatAq<HCO_3^-\ice><##>}      {hydrogen carbonate}

{2C}
 CH3COOm_i    = IGNORE; {@\FormatAq<CH_3COO^-\ice><##>}    {acetate}

{------------------------------------- Cl ------------------------------------}

 Clm_i        = IGNORE; {@\FormatAq<Cl^-\ice><##>}         {chloride}
 Cl2m_i       = IGNORE; {@\FormatAq<Cl_2^-\ice><##>}       {}
 ClOm_i       = IGNORE; {@\FormatAq<ClO^-\ice><##>}        {}
 ClOHm_i      = IGNORE; {@\FormatAq<ClOH^-\ice><##>}       {}

{------------------------------------- Br ------------------------------------}

 Brm_i        = IGNORE; {@\FormatAq<Br^-\ice><##>}         {bromide}
 Br2m_i       = IGNORE; {@\FormatAq<Br_2^-\ice><##>}       {}
 BrOm_i       = IGNORE; {@\FormatAq<BrO^-\ice><##>}        {}
 BrOHm_i      = IGNORE; {@\FormatAq<BrOH^-\ice><##>}       {}
 BrCl2m_i     = IGNORE; {@\FormatAq<BrCl_2^-\ice><##>}     {}
 Br2Clm_i     = IGNORE; {@\FormatAq<Br_2Cl^-\ice><##>}     {}

{------------------------------------- I -------------------------------------}

 Im_i         = IGNORE; {@\FormatAq<I^-\ice><##>}          {iodide}
 IO2m_i       = IGNORE; {@\FormatAq<IO_2^-\ice><##>}       {}
 IO3m_i       = IGNORE; {@\FormatAq<IO_3^-\ice><##>}       {iodate}
 ICl2m_i      = IGNORE; {@\FormatAq<ICl_2^-\ice><##>}      {}
 IClBrm_i     = IGNORE; {@\FormatAq<IClBr^-\ice><##>}      {}
 IBr2m_i      = IGNORE; {@\FormatAq<IBr_2^-\ice><##>}      {}

{------------------------------------- S -------------------------------------}

 SO3m_i       = IGNORE; {@\FormatAq<SO_3^-\ice><##>}       {}
 SO3mm_i      = IGNORE; {@\FormatAq<SO_3^<2->\ice><##>}    {sulfite}
 SO4m_i       = IGNORE; {@\FormatAq<SO_4^-\ice><##>}       {}
 SO4mm_i      = IGNORE; {@\FormatAq<SO_4^<2->\ice><##>}    {sulfate}
 SO5m_i       = IGNORE; {@\FormatAq<SO_5^-\ice><##>}       {}
 HSO3m_i      = IGNORE; {@\FormatAq<HSO_3^-\ice><##>}      {hydrogen sulfite}
 HSO4m_i      = IGNORE; {@\FormatAq<HSO_4^-\ice><##>}      {hydrogen sulfate}
 HSO5m_i      = IGNORE; {@\FormatAq<HSO_5^-\ice><##>}      {}
 CH3SO3m_i    = IGNORE; {@\FormatAq<CH_3SO_3^-\ice><##>}   {}
 CH2OHSO3m_i  = IGNORE; {@\FormatAq<CH_2OHSO_3^-\ice><##>} {}

{-----------------------------------------------------------------------------}
{------------------------------------ dummies --------------------------------}
{-----------------------------------------------------------------------------}

 D1O_i        = IGNORE; {@\FormatAq<D_1O\ice><##>}         {}
 D2O_i        = IGNORE; {@\FormatAq<D_2O\ice><##>}         {}
 DAHp_i       = IGNORE; {@\FormatAq<DAH^+\ice><##>}        {}
 DA_i         = IGNORE; {@\FormatAq<DA\ice><##>}           {}
 DAm_i        = IGNORE; {@\FormatAq<DA^-\ice><##>}         {}
 DGtAi_i      = IGNORE; {@\FormatAq<DGtAi\ice><##>}        {}
 DGtAs_i      = IGNORE; {@\FormatAq<DGtAs\ice><##>}        {}
 PROD1_i      = IGNORE; {@\FormatAq<PROD1\ice><##>}        {}
 PROD2_i      = IGNORE; {@\FormatAq<PROD2\ice><##>}        {}
 Nap_i        = IGNORE; {@\FormatAq<Na^+\ice><##>}         {dummy cation}

{ mz_ak_20060516+} 
{ defined in gas.spc to avoid doubling}
{BrSScap       = IGNORE; }{@\FormatAq<IGNORE><##>} {yield of Br to SS}
{ mz_ak_20060516-}
{**** END:   aerosol species (phase 1) from ice.spc ****}
{SETFIX H2O_* is done via xscav_i}
#SETFIX H2O_i;
