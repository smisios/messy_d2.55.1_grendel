...
# Author: Patrick Joeckel (2014), select replacement file with updates
#         by Domenico Taraborrelli
# - used for CCMI RC1SD-sens-01
...
# when it is run in batch mode (i.e. not interactive).
 ...
 set rplfile      = mim1-CCMI-sens-01 # back to MIM1, then other replacements
