...
# when it is run in batch mode (i.e. not interactive).
 ...
 set gaseqnfile   = eqn/cb05bascoe/cb05bascoe.eqn
 set ignoremassbalance                # cb05bascoe violates the mass balance
 set ignorecarboncount                # cb05bascoe violates the carbon count
