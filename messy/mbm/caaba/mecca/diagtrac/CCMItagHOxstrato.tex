...
%
% HOWTO:
%  (1) create mecca.eqn with mim1-CCMI2-base-01.rpl,
%      but with zero diagnostic tracers (edit CCMI2-base-01.bat)
%  (2) run prodloss on mecca.eqn
%      -> from diag.log -> check hand-coded CCMI2-base-01-raw.tex
%         according to log-file of prodloss
%  (3) append CCMI2-base-01-raw.tex to this file
%      (CCMI2-base-01.tex = output from prodloss)
%  (4) re-create mecca.eqn with mim1-CCMI2-base-01.rpl AND
%      diagtracfile = CCMI2-base-01 # (.tex; this file)
%
% - The submodel O3ORIG needs effective ozone production and loss terms.
%   These are LossO3 and ProdO3, as produced by prodloss with mecca.eqn
%   (the latter with (!) replacements).
%
% - For diagnostical purpose individual production and loss terms are defined:
%       Troposphere: ProdHO2    Ozone production via NO+HO2
%                    ProdMeO2   Ozone production via NO+CH3O2
%                    ProdRO2    Ozone production via NO+RO2
%                    LossOH     Ozone loss via O3+OH
%                    LossHO2    Ozone loss via O3+HO2
%                    LossO1D    Ozone loss via H2O+O1D
%                               (see Ozone definition below)
%                               = OH Production!
%
%       Stratosphere: LossO3x  x=O, N, H, Cl, Br loss processes
%                     via Ox, NOx, HOx, ClOx, and BrOx ozone desctruction.
%
% - ProdRO2 has been adapted to fit the ozone definition below.
%
% - Production terms for BrOx from emitted species according to their
%   lifetime (VSLS=s and others =l) dignosed.
%
% - rpl file mim1-CCMI-base-01.rpl considered
% ----------------------------------------------------------------------------
%
 ...
 %                +    2.0      x CH3SO3
 %                +    2.0      x CH3SO3H
 <G1002a>        &    2.0      LossO3 & O3 + O1D = 2 O2 :
 <G1003>         &    2.0      LossO3 & O3 + O3P = 2 O2 :
%<G1004>         &    1.0      ProdO3 & O2 + Op = O2p + O3P :
%<G1101>         &    2.0      ProdO3 & O2p + em = 2 O3P :
...
%<G2113>         &    1.0      LossO3 & H2 + O3P = H + OH :
%<G2114a>        &    1.0      ProdO3 & OH + OH = H2O + O3P :
%<G2116>         &    1.0      LossO3 & H2O2 + O3P = OH + HO2 :
%<G3001>         &    1.0      ProdO3 & NOp + em = 0.15 N + 0.85 N2D + O3P :
...
%<G3111>         &    1.0      ProdO3 & N2D + NO = N2 + O3P :
%<G3112>         &    1.0      ProdO3 & N2D + O2 = NO + O3P :
%<G3114>         &    1.0      LossO3 & N2D + O3 = NO + O2 :
%<G3119>         &    1.0      LossO3 & N2p + O3P = NOp + N2D :
%<G3120a>        &    1.0      ProdO3 & Np + O2 = NOp + O3P :
%<G3121>         &    1.0      LossO3 & Np + O3P = Op + N :
%<G3122>         &    1.0      ProdO3 & O2p + N = NOp + O3P :
...
%<G4113>         &    1.0      LossO3 & CH4 + O3P = CO + 2 OH + H2O :
...
%<G10100>        &    1.0      LossO3 & Hg + O3 = HgO + O2 :
%<G10703>        &    1.0      LossO3 & Hg + BrO = HgO + Br :
%<G10704>        &    1.0      LossO3 & HgBr + BrO = BrHgOBr :
%<G10705>        &    1.0      LossO3 & HgCl + BrO = ClHgOBr :
%<J0001>         &    1.0      LossO3 & O3P = Op + 2 em :
%<J0002b>        &    1.0      ProdO3 & O2 = Op + O3P + em :
 <J1000a>        &    2.0      ProdO3 & O2 + hv = O3P + O3P :
%<J1000b>        &    2.0      ProdO3 & O2 + hv = O3P + O1D :
%<J1000d>        &    1.0      ProdO3 & O2 + hv = Op + O3P :
%<J1002>         &    1.0      LossO3 & O3P + hv = Op :
%<J2100b>        &    1.0      ProdO3 & H2O + hv = H2 + O1D :
...
% ----------------------------------------------------------------------------
% %%% attached hand-coded definitions (see HOWTO above)
% ----------------------------------------------------------------------------
%
% %%% -----------------------------------------------------------------------
...
% %%% -----------------------------------------------------------------------
% %%% -----------------------------------------------------------------------
% %%% additional diagnostics for TAGGING submodel
% %%% (required in addition to O3 budget diagnostics)
