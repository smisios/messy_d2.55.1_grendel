...
%
% HOWTO:
%  (1) create mecca.eqn with mim1-CCMI2-base-01-ISO-nmo.rpl,
%      but with zero diagnostic tracers (edit CCMI2-base-01-ISO-nmo.bat)
%  (2) run prodloss on mecca.eqn
%      -> from diag.log -> check hand-coded CCMI2-base-01-ISO-nmo-raw.tex
%         according to log-file of prodloss
%  (3) append CCMI2-base-01-ISO-nmo-raw.tex to this file
%      (CCMI2-base-01-ISO-nmo.tex = output from prodloss)
%  (4) re-create mecca.eqn with mim1-CCMI2-base-01-ISO-nmo.rpl AND
%      diagtracfile = CCMI2-base-01-ISO-nmo # (.tex; this file)
%
...
%
% - rpl file mim1-CCMI2-base-01.rpl considered
% ----------------------------------------------------------------------------
%
 ...
 <G4116>         &    2.0      ProdO3 & CH3O2NO2 + OH = HCHO + NO3 + H2O : 
...
% <J7301>         &    5.96046448E-08  ProdO3 & BrNO3 + hv = .85 Br + .85 NO3 + .15 BrO + .15 NO2 : % op_pj_20200326 zero!
...
%<G9400a> &          & DMS        + OH = CH3SO2 + HCHO + H2O
%<G9400b> &          & DMS        + OH = DMSO + HO2
%<G9402>  &          & DMSO       + OH = .6 H2O + .6 SO2 +  HCHO + .6 CH3O2 + .4 HO2 + .4 CH3SO3H
...
% O-Group: GHGs + O: O3, H2O, N2O, CH4, CFCs
 ...
 <G4156>         &   1.0      LossO3O & CH3O2 + O3P = CH3O + O2 :
