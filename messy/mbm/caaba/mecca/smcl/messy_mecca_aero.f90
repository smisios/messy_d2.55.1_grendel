!*****************************************************************************
! Time-stamp: <2020-06-30 11:44:29 b302010>
!*****************************************************************************
...
MODULE messy_mecca_aero
  ...
  REAL(DP), PUBLIC, SAVE :: alpha_T0(0:NSPEC), alpha_Tdep(0:NSPEC)
  REAL(DP), PUBLIC, SAVE :: Henry_T0(0:NSPEC), Henry_Tdep(0:NSPEC)
  REAL(DP), PUBLIC, SAVE :: molar_mass(0:NSPEC)
