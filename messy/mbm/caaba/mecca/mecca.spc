...
{--- diagnostic tracers from CMIP6-v03.tex, added via xmecca ---}
#DEFVAR
LossCH4 = IGNORE ; {@LossCH4}
LossCO = IGNORE ; {@LossCO}
LossN2O = IGNORE ; {@LossN2O}
LossO3 = IGNORE ; {@LossO3}
ProdO3 = IGNORE ; {@ProdO3}
