#!/usr/bin/env python3
# -*- coding: utf-8 -*- Time-stamp: <2019-06-01 23:51:45 sander>
...
class viewport(object):
    ...
    @classmethod
    def init(cls, x, y, pdffile, xsize=None, ysize=None):
        ...
        if (os.path.isfile(pdffile)):
            print('deleting old file: %s' % (pdffile))
            os.remove(pdffile)
        cls.pdffile = pdffile
    ...
    @classmethod
    def scientificNotation(cls, value, three=True):
        import numpy as np
        import math
        if (value == 0):
            return '0'
    ...
    def timeformat(cls, value, pos=None):
        import matplotlib
