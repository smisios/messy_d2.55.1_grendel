...
ifeq ($(strip $(OUTPUT)), NETCDF)
link:
# with netcdf library:
	ln -fs mo_netcdf.f90-real mo_netcdf.f90
else
link:
# without netcdf library:
	ln -fs mo_netcdf.f90-ascii mo_netcdf.f90
	NETCDF_LIB=
endif
...
.PHONY: zip
zip:
	@./_zipcloudj.tcsh zip verbose

.PHONY: zipall
zipall:
	@./_zipcloudj.tcsh zipall verbose
