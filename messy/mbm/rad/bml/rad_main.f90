...
!!$                                    , messy_tracer_afteradv
  ...
  IF (lstop) THEN
     CALL messy_blather_endfile_bi('SIMULATION FINISHED','rad')
  ELSE
     CALL info_bi('SIMULATION INTERRUPTED','rad')
  ENDIF
