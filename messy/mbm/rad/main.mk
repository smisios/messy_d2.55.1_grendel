...
# ---------------------------------------------------------------
SRCDIRS  = smcl smil bmil bml e5_modules
LIBSRCS  = smcl
...
LIBS     = $(BLANK_LIB)
#F90DEFS0 = BLANK $(MPI)
#F90DEFS0 = MESSY BLANK
F90DEFS0 = MESSY BLANK MBM_RAD NOMPI
...
.PHONY: check
check:
	../../util/mfchk rad "$(F90DEFS0)" "$(SRCDIRS) $(LIBSRCS)" "$(ECHAM5_INCLUDE)" "$(F90)" "$(FCKLIBS)"
...
-include $(REDIR)/e5_modules/specific.mk
