Module messy_clamschem_asad_inimpct

contains


!
!     inimpct     -  Initalisation routine for IMPACT integrator.
!
...
!
        ...
        USE messy_clamschem_asad_mod_clams, ONLY: jpctr, jppj
...
!             See if there's any more with the same reactant.
      ...
      End Module messy_clamschem_asad_inimpct
