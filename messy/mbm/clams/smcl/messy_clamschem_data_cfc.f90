MODULE MESSY_CLAMSCHEM_DATA_CFC
  ...
  TYPE(CHCH_T), DIMENSION(:), ALLOCATABLE :: chch_defs_cfc
  TYPE(RATB_T), DIMENSION(:), ALLOCATABLE :: ratb_defs_cfc
  TYPE(RATT_T), DIMENSION(:), ALLOCATABLE :: ratt_defs_cfc
  TYPE(RATJ_T), DIMENSION(:), ALLOCATABLE :: ratj_defs_cfc
  TYPE(RATH_T), DIMENSION(:), ALLOCATABLE :: rath_defs_cfc
  
CONTAINS

SUBROUTINE CLAMS_CHEM_INIT_CFC()
  ...
  ALLOCATE(chch_defs_cfc(jpspec))
  ALLOCATE(ratb_defs_cfc(jpbk))
  ALLOCATE(ratj_defs_cfc(jppj))
  ALLOCATE(ratt_defs_cfc(jptk))
  ALLOCATE(rath_defs_cfc(jphk))
...
.60, 4.40E-32, -1.30,       .0, 7.50E-11,  0.20,       .0, 0.000, 0.000)  &  
  /)
   ...
   END SUBROUTINE CLAMS_CHEM_INIT_CFC


   SUBROUTINE CLAMS_CHEM_CLEAN_CFC

     implicit none

     DEALLOCATE(chch_defs_cfc)
     DEALLOCATE(ratb_defs_cfc)
     DEALLOCATE(ratj_defs_cfc)
     DEALLOCATE(ratt_defs_cfc)
     DEALLOCATE(rath_defs_cfc)

   END SUBROUTINE CLAMS_CHEM_CLEAN_CFC


END MODULE MESSY_CLAMSCHEM_DATA_CFC
