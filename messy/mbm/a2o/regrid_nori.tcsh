...
set INPUTDIR = "/mpcdata/user/bkern/test_nori"
set OUTPUTDIR = "/mpcdata/user/bkern/tracer_om_regrid/test_nori"
...
foreach FILE (`/bin/ls ${INPUTDIR}/*${NCFILE}.nc`)
  ...
  cat ${TEMPLATENML} | sed 's|$INFILE|'${FILE}'|g;s|$OUTFILE|'${OUTPUTFILE}'|g;s|$NT|'${TIMESTEPS}'|g;' > regrid_nori_tmp.nml

  ${A2O}/a2o.exe regrid_nori_tmp.nml
