...
set INPUTDIR = "/mpcdata/user/bkern/test_ri"
set OUTPUTDIR = "/mpcdata/user/bkern/tracer_om_regrid/test_ri"
...
foreach FILE (`/bin/ls ${INPUTDIR}/*${NCFILE}.nc`)
  ...
  cat ${TEMPLATENML} | sed 's|$INFILE|'${FILE}'|g;s|$OUTFILE|'${OUTPUTFILE}'|g;s|$NT|'${TIMESTEPS}'|g;' > regrid_ri_tmp.nml

  ${A2O}/a2o.exe regrid_ri_tmp.nml
