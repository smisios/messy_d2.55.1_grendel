...
def parse_cuda_mk_template(template,output,arch,global_mem,flags=""):
...
def print_menu_make_selection(ros, gpu, mem):
    if gpu is None:
        print ("""

    Select CUDA architecture (1-6):

                1. CUDA 2.0 ( FERMI architecture | CUDA 3-8    | best compatibility      )
                2. CUDA 3.5 ( KEPLER or later    | CUDA 5-10   |                         )
                3. CUDA 5.2 ( MAXWELL or later   | CUDA 6.5-10 | Quadro M2+ / Tesla M    )
                4. CUDA 6.1 ( PASCAL or later    | CUDA 8-10   | Quadro P / Tesla P      )
                5. CUDA 7.0 ( VOLTA or later     | CUDA 9-10   | Quadro GV / Tesla V100  )
                6. CUDA 7.5 ( TURING or later    | CUDA 10     | Quadro RTX/T / Tesla T4 )
...
Select Rosenbrock solver (1-6): 
    ...
    print("Selected options: " + arch + " with ros: "  + ros + " and reduced mem.: "+ mem + "\n")
    return ros, arch, mem
...
ros, arch, mem = print_menu_make_selection(ros, gpu, mem)
...
print("\n+==========================================================================+ ")
print("| KPP Fortran to CUDA praser - Copyright 2016 - 2020 The Cyprus Institute  |")
print("+==========================================================================+ \n")
...
parse_cuda_mk_template(proto_mk, mecca_smcl+output_mk, arch, global_mem)
