...
!       integer, parameter :: nsubdomains_y  = 1 ! No of subdomains in y
  ...
  integer :: nsubdomains_x ! No of subdomains in x
  integer :: nsubdomains_y ! No of subdomains in y
  integer :: YES3D   ! Domain dimensionality: 1 - 3D, 0 - 2D
  integer :: nx_gl   ! Number of grid points in X
  integer :: ny_gl   ! Number of grid points in Y
  integer :: nz_gl   ! Number of pressure (scalar) levels
...
!  integer, parameter :: ntracers = 0 ! number of transported tracers (dotracers=.true.)
  ...
  integer :: ntracers   ! number of transported tracers (dotracers=.true.)
