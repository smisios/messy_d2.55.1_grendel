  ...
  interface nf90_def_var
    module procedure nf90_def_var_Scalar, &
         nf90_def_var_oneDim, nf90_def_var_ManyDims
  ...
  interface nf90_put_att
    module procedure &
         nf90_put_att_text,         &
#if !(defined(__SX__) || defined(SX))
         nf90_put_att_OneByteInt,   &
         nf90_put_att_TwoByteInt,   &
#endif
         nf90_put_att_FourByteInt,  &
         nf90_put_att_EightByteInt, &
         nf90_put_att_FourByteReal, &
         nf90_put_att_EightByteReal
    module procedure &
#if !(defined(__SX__) || defined(SX))
  ...
  interface nf90_get_att
    module procedure &
         ...
         nf90_get_att_EightByteInt, &
         nf90_get_att_FourByteReal, &
         nf90_get_att_EightByteReal
    module procedure &
#if !(defined(__SX__) || defined(SX))
