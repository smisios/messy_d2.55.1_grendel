  ...
  function nf90_put_att_one_FourByteInt(ncid, varid, name, values)
    ...
    nf90_put_att_one_FourByteInt = nf_put_att_int(ncid, varid, name, nf90_int, 1, int(values))
  ...
  function nf90_put_att_one_EightByteInt(ncid, varid, name, values)
    ...
    nf90_put_att_one_EightByteInt = nf_put_att_int(ncid, varid, name, nf90_int, 1, int(values))
